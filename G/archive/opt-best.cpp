...
inline bool opt2LocalOptimal(int i,double localfactor=2,int maxnumberneighbor=20){
//    FOR(direction,1){
...
inline void opt2Base(double localfactor=2,int maxnumberneighbor=20){
    if(timecheck())return;
    while(1){
        int change=0;
        FOR(i,n){
            bool improve=opt2LocalOptimal(i,localfactor,maxnumberneighbor);
            if(improve)change=1;
...
inline bool opt3LocalOptimal(int i,double localfactor,int maxnumberneighbor=20){
...
inline void opt3Base(double localfactor,int maxnumberneighbor=20){
    while(1){
        int change=0;
        FOR(i,n-1){
            bool improve=opt3LocalOptimal(i,localfactor,maxnumberneighbor);
            if(improve)change=1;
        }
        if(!change)break;
        if(timecntcheck())return;
...
void solve() {
    ...
    FOR(seed,100000){
        ...
        opt2Base(1,maxnumberneighbor);
//        opt2Base(-1,maxnumberneighbor,false,0);
        opt3Base(-1,maxnumberneighbor);
        if(mindis>curdis){
